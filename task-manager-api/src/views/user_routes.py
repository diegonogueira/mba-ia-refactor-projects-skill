"""Rotas de usuários e login: apenas URL + método → controller."""
from flask import Blueprint


def build_user_blueprint(controller) -> Blueprint:
    ...
    blueprint.add_url_rule('/users/<int:user_id>/tasks', 'list_user_tasks', controller.list_user_tasks,
                           methods=['GET'])
