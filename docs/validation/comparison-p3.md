...
| 22 | GET | `/users/1` | 200 | 200 | DIFERENTE (esperado: GET /users/<id> sem o hash de senha (exceção 1: dados sensíveis)): shape (-password) |
...
| 32 | POST | `/login` | 200 | 200 | DIFERENTE (esperado: POST /login sem o hash de senha em user (exceção 1)): shape (-user.password) |
...
| 44 | DELETE | `/users/3` | 200 | 200 | igual |
