...
produto_bp.add_url_rule("/produtos", "criar_produto", controller.criar_produto, methods=["POST"])
produto_bp.add_url_rule("/produtos/<int:produto_id>", "atualizar_produto", controller.atualizar_produto, methods=["PUT"])
produto_bp.add_url_rule("/produtos/<int:produto_id>", "deletar_produto", controller.deletar_produto, methods=["DELETE"])
